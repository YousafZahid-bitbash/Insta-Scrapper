										...
										>
											<div className="flex w-full gap-4 items-start">
												...
												<div className="flex flex-col items-start gap-2 min-w-[160px]">
													<label className="text-sm text-gray-700 font-medium mb-1">Coin Limit</label>
													<input
														type="number"
														min={0}
														className="px-4 py-2 rounded-xl border-2 border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#d4af37] font-serif text-lg shadow-sm w-full"
														value={coinLimit}
														onChange={e => setCoinLimit(Number(e.target.value))}
													/>
													<span className="text-xs text-gray-500">Stop automatically when this coin limit is reached.</span>
													<span className="text-xs text-yellow-700 mt-2">Estimated coins: {estimatedCoins}</span>
												</div>
											</div>
											<button
												type="submit"
